...
function parseOutput(outFileName, callback) {
    ...
    var array = fs.readFileSync('/home/bitnami/imt/outputs' + outFileName).toString().split('\n');
...
function parseResFile(resFileName, callback) {
    ...
    var array = fs.readFileSync('/home/bitnami/imt/outputs' + resFileName).toString().split('\n');
