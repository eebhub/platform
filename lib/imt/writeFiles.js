...
function moveFiles(insFileName, dataFileName, outputFileName, resFileName, callback) {
    fs.rename('./' + insFileName, '../imt/inputs/' + insFileName);
    fs.rename('./' + dataFileName, '../imt/inputs/' + dataFileName);
    fs.rename('./' + resFileName, '../imt/outputs/' + resFileName);
    fs.rename('./' + outputFileName, '../imt/outputs/' + outputFileName);
    callback();
}
