    ...
    getWeatherData: function(utility_startdate, airportCode, fn) {
        ...
        function getUrls(utility_startdate, airportCode) {
            ...
            for (var i = 0; i < utility_startdate.length - 1; i++) {
                ...
                urls[i] = "http://www.wunderground.com/history/airport/" + airportCode + "/" + yearStart + "/" + monthStart + "/" + dayEnd + "/CustomHistory.html?dayend=" + dayEnd + "&monthend=" + monthEnd + "&yearend=" + yearEnd + "&req_city=NA&req_state=NA&req_statename=NA&format=1";
            }
            return urls;
        }
